...
const Footer = () => {
  return (
    <div className="footer min-h-[50vh] border mt-5 flex p-5 justify-between bg-red-100">
        <style>{`
                .other_links{
                    ul{
                    margin-top:20px;
        ...
        `}</style>
        <div className="text-description w-1/3 text-justify">
        ...
        <div className="other_links">
            <p className='font-bold border-b border-black p-1'>Links</p>
            <ul>
        ...
        <div className="foundations flex place-content-center place-items-center gap-5">
            <div className="found text-center">
                <img src="https://img.freepik.com/free-vector/colorful-bird-illustration-gradient_343694-1741.jpg?t=st=1723219086~exp=1723222686~hmac=5c5f6c6bcf809e34d278bfad51d2aecc04100df3c96658115aa040bb250c7add&w=826" alt="hbrf" height={100} width={100}/>
            ...
            <div className="found text-center">
                <img src="https://th.bing.com/th/id/R.c21b6f7c9ac5474afbc35a7c0d64fdb6?rik=IgOrhoJe3BlgMw&pid=ImgRaw&r=0" alt="hbrf" height={100} width={100}/>
